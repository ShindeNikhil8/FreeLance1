...
export default function Hero() {
  ...
  <div className="relative z-10 text-center px-6">
    <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold" style={{ textShadow: "2px 2px 6px rgba(0,0,0,0.8)" }}>
      A One Industries
    </h1>

    <p className="mt-4 text-xl sm:text-2xl text-slate-200 max-w-2xl mx-auto" style={{ textShadow: "2px 2px 6px rgba(0,0,0,0.8)" }}>
    ...
    <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
      ...
      >
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-md">
          ...
          <p className="mt-2 text-slate-300">States Served</p>
        </div>
      </Motion.div>
